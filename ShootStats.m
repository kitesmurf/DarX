...
-(void)add:(id)sender 
{
	...
	NSNumber *aveScore =  [[NSNumber alloc]initWithFloat:(score/[throws intValue]/3)];
	NSNumber *aveScore3 = [[NSNumber alloc]initWithFloat:(score/[throws intValue])];
    ...
    [nc postNotificationName:shootOutSaved object:self];
